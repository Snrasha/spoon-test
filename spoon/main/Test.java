...
@Blob(currentAttributes = 19, currentLackOfCohesionMethods = 741, currentMethods = 27, limitAttributes = 13, limitLackOfCohesionMethods = 40, limitMethods = 22)
public class Test {
    @Igs
    ...
    @Lm(currentInstructions = 32, limitInstructions = 26)
